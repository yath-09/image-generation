  ...
  return (
    <div className="flex justify-center p-6">
      <div className="w-full max-w-lg bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-3xl font-semibold text-center mb-6 text-[#444444]">Generate AI Image</h2>
        <h2 className="text-2xl font-semibold mb-2 text-black">Step-1 Select Model</h2>
